        ...
        <div className='absolute top-[45%] left-5 sm:left-[7%] md:left-[4%] lg:left-[5%] flex w-[90%] lg:w-[90%] h-[100vh] flex-wrap flex-row justify-between items-center'>
            <div className='bg-white h-full w-full sm:w-full md:w-full lg:w-[32%]'>
                ...
                <div className='p-4 w-full'>
                    <h2 className='text-center text-[18px] font-semibold bg-green-800 text-white p-4 rounded-[10px] m-auto w-[50%]'>Choisissez ou inscrivez le montant de votre offre</h2>
                    {/* <button onClick={() => setBtn(!btn)} className='p-4 text-center m-auto'>{btn ? "Afficher les choix" : "Afficher montant libre"}</button> */}
                    <div className="mt-10">
                        <select onChange={(e) => setSelectedAmount(e.target.value)} disabled={dropdownActive} className='w-full outline-none p-2 bg-blue-800 bg-opacity-70 text-white text-[24px]' name="" id="">
                        <option defaultChecked value="">Choisir</option>
                        {
                        ...
                        <div className='my-5 font-bold text-center w-full text-[20px]'>OU</div>
                        <div className='flex border border-gray-400 rounded-[7px] flex-row justify-between items-center mt-2 w-full m-auto'>
                        <input disabled={textInputActive} type="number" min={1} onChange={(e) => setInputAmount(e.target.value)} className='p-3 ml-1 outline-none text-[20px] w-[80%]' placeholder='Montant Libre' id="" />
