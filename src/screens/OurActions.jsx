  ...
  return (
    ...
    <div className="w-full relative h-3/6 lg:1/6 md:2/6 sm:3/6">
        ...
        <img src={pub3} className="h-full" alt="Image Publication" />
            ...
            {
              subLinks[0].label === selectedLink.label ?
              <div
              className='p-4'
            >
            ...
            { subLinks[1].label === selectedLink.label && <div
              className='p-4'
            >
            ...
            { subLinks[2].label === selectedLink.label && <div
              className='p-4'
            >
            ...
            { subLinks[3].label === selectedLink.label && <div
              className='p-4'
            >
            ...
            { subLinks[4].label === selectedLink.label && <div
              className='p-4'
            >
